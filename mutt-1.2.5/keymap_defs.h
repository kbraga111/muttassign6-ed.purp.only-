...
const char *HelpStrings[] = {
	...
	N_("recode this attachment to/from the local charset"),
	...
	N_("show PGP options"),
	N_("extract PGP public keys"),
	N_("wipe PGP passphrase from memory"),
